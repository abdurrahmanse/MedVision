...
export function UploadZone({ onFileChange }: UploadZoneProps) {
  return (
    <div className="border-[3px] sm:border-4 border-dashed border-gray-400 dark:border-gray-600 rounded-xl sm:rounded-3xl p-8 sm:p-12 lg:p-20 text-center hover:bg-white/60 dark:hover:bg-gray-800/60 transition-colors group cursor-pointer relative shadow-inner">
      ...
      <h3 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-gray-100 mb-2 sm:mb-3 tracking-tight">Drop Chest X-Ray Here</h3>
      <p className="text-gray-600 dark:text-gray-400 font-bold mb-6 sm:mb-8 text-base sm:text-lg">PNG or JPG (Max 5MB)</p>
      
      <label className="inline-flex items-center justify-center w-full sm:w-auto gap-2 sm:gap-3 bg-blue-500 text-white border-2 border-black dark:border-white shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] sm:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[3px_3px_0px_0px_rgba(255,255,255,1)] dark:sm:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] hover:shadow-none hover:translate-y-[3px] hover:translate-x-[3px] sm:hover:translate-y-[4px] sm:hover:translate-x-[4px] px-6 py-3 sm:px-8 sm:py-4 rounded-lg sm:rounded-xl font-black text-lg sm:text-xl cursor-pointer transition-all">
