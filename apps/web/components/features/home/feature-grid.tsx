  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 w-full px-4 sm:px-0">
      <GlassCard hoverEffect className="p-6 sm:p-8">
        ...
        <h2 className="text-2xl sm:text-3xl font-black mb-2 sm:mb-3 text-gray-900 dark:text-white tracking-tight">Upload & Predict</h2>
      ...
      <GlassCard hoverEffect className="p-6 sm:p-8">
        ...
        <h2 className="text-2xl sm:text-3xl font-black mb-2 sm:mb-3 text-gray-900 dark:text-white tracking-tight">Inference History</h2>
      ...
      <GlassCard hoverEffect className="p-6 sm:p-8 md:col-span-2 lg:col-span-1">
        ...
        <h2 className="text-2xl sm:text-3xl font-black mb-2 sm:mb-3 text-gray-900 dark:text-white tracking-tight">How it Works</h2>
